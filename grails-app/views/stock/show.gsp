		...
		<div id="show-stock" class="content scaffold-show" role="main">
			...
			<g:form url="[resource:stockInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" controller="master" params="[cntlr:'stock',function:'edit',instanceId:stockInstance.id]">
						<g:message code="default.button.edit.label" default="Edit" />
					</g:link>
					<g:link class="edit" controller="stock" action="addToBasket" id="${stockInstance.id }">Purchase</g:link>
