...
<html>
	...
	<body>
		<div id="create-category" class="well bs-component col-md-6 col-md-offset-3" role="main">
			...
			<g:form url="[resource:categoryInstance, action:'save',controller:'category']" controller="category" >
				<fieldset class="form">
